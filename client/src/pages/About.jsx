      ...
      <div className="relative z-10 max-w-7xl mx-auto p-10 text-center">
        ...
        >
          <p className="text-lg leading-relaxed mb-6">
            Welcome to <strong>KRISHI PRABANDHAN </strong>, a one-stop solution
          ...
          <p className="text-lg leading-relaxed mb-6">
            At KRISHI PRABANDHAN , we aim to bridge the gap between technology
        ...
        {/* Button Animation */}
        <motion.a
          href="mailto:eshwarsai07edu@gmail.com"
